...
class ImageController {
  ...
  async index({ transform, response, pagination }) {
    ...
    var images = await Image.query().orderBy('id', 'DESC').paginate(page, limit)
    ...
    try {
      ...
      if (!fileJar.files) {
        ...
        if (file.moved()) {
          ...
          const transformedImages = await transform.idem(image, Transformer)
